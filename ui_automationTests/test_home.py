...
#
#
# url = driver.get("http://127.0.0.1:5000/")
#
# print(url)
# # title = driver.title
# # print(title)
...
def test_lambdatest_todo_app():
    # chrome_driver = webdriver.Chrome(executable_path="C:\\seleniumdriver\\chromedriver.exe")
    # chrome_driver = webdriver.Chrome()
    chrome_driver = webdriver.Chrome(executable_path="C:\\seleniumdriver\\chromedriver.exe")
    chrome_driver.get('https://lambdatest.github.io/sample-todo-app/')
    chrome_driver.maximize_window()

    chrome_driver.find_element("li1").click()
